<!DOCTYPE html>
<html lang="fa" class="light-style layout-navbar-fixed layout-menu-fixed" dir="rtl" data-theme="theme-default" data-assets-path="{{ asset('admin/') }}/" data-template="vertical-menu-template-starter">
  <head>
    <meta charset="utf-8">
                        ...
                        <a class="dropdown-item" href="#">
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              <span class="fw-semibold d-block">{{ auth('admin')->user()->name ?? 'مدیر' }}</span>
                              <small>مدیر</small>
                            </div>
                          </div>
                        </a>
