...
<html lang="fa" class="light-style customizer-hide" dir="rtl" data-theme="theme-default" data-assets-path="{{ asset('admin/') }}/" data-template="vertical-menu-template">
  <head>
    ...
    <title>ورود مدیریت - {{ config('app.name') }}</title>
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">لطفا وارد حساب خود شده و به پنل مدیریت دسترسی پیدا کنید</p>
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('admin.login.submit') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control text-start" id="email" name="email" placeholder="example@domain.com" value="{{ old('email') }}" required autofocus dir="ltr">
                </div>

                <div class="mb-3 form-password-toggle">
                  <label class="form-label" for="password">رمز عبور</label>
                  <div class="input-group input-group-merge">
                    <input type="password" id="password" class="form-control text-start" name="password" placeholder="············" required aria-describedby="password" dir="ltr">
